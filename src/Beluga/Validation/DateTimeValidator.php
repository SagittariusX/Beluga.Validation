<?php
/**
 * In this file the class {@see \Beluga\Validation\DateTimeValidator} is defined.
 *
...
/**
 * This class defines a validator that allows only valid date+time values.
 *
 * @property mixed   $MinValue The minimal allowed datetime value or NULL if no min value should be used (default=null)
 * @property mixed   $MaxValue      The max allowed datetime value or NULL if no max should used (default=null)
...
class DateTimeValidator extends Validator
{
    ...
    * Usable options are:
    *
    * - <b>MinValue</b>: The minimal allowed datetime value or NULL if no min value should be used (default=null)
    * - <b>MaxValue</b>: The maximal allowed datetime value or NULL if no max value should be used (default=null)
    *
   ...
   public function __construct( array $options = [] )
   {
      ...
      self::setDateTimeOption( 'MinValue',    $options );
      self::setDateTimeOption( 'MaxValue',    $options );
      self::setStringOption  ( 'DisplayName', $options, static::$errors[ 12 ] );
    ...
    * @return \Beluga\Validation\DateTimeValidator
    */
      ...
      : DateTimeValidator
   {
      ...
      $this->__setDateTimeOption( 'MinValue', $value, null );
      ...
      : DateTimeValidator
   {
      ...
      $this->__setDateTimeOption( 'MaxValue', $value, null );
   ...
   protected function __validate()
   {
         ...
         && $this->_options[ 'Result' ] < $this->_options[ 'MinValue' ] )
      {
         ...
         $this->_message = \sprintf(
            static::$errors[ 4 ],
            $this->_options[ 'MinValue' ]->formatSqlDateTime()
         );
         ...
         && $this->_options[ 'Result' ] > $this->_options[ 'MaxValue' ] )
      {
         ...
         $this->_message = \sprintf(
            static::$errors[ 5 ],
            $this->_options[ 'MaxValue' ]->formatSqlDateTime()
         );
