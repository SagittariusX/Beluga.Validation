...
use \Beluga\Validation\{DateTimeValidator,InputType};
...
class DateTimeValidatorTest extends PHPUnit_Framework_TestCase
{
    ...
    * @covers Beluga\Validation\DateTimeValidator::getOption
    * @covers Beluga\Validation\DateTimeValidator::setOption
    * @covers Beluga\Validation\DateTimeValidator::setMinValue
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::getOption
    * @covers Beluga\Validation\DateTimeValidator::setOption
    * @covers Beluga\Validation\DateTimeValidator::setMaxValue
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::setAllowEmpty
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::setRequired
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::setDefaultValue
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::setRequiredValue
    */
    ...
    * @covers Beluga\Validation\DateTimeValidator::setDisplayName
    */
